...
namespace big::vehicle
{
	...
	std::map<int, int32_t> get_vehicle_data_from_vehicle_idx(script_global vehicle_idx)
	{
	...
	void delete_last_spawned(Vehicle veh)
	{
		Vehicle lastspawned = PLAYER::GET_PLAYERS_LAST_VEHICLE();
		 entity::delete_entity(lastspawned);
	}
